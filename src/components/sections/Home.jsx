    ...
    >
      <div className="text-center z-10 px-4">
        ...
        <p className="text-xs sm:text-sm md:text-base mb-8 text-gray-400 max-w-2xl mx-auto px-8">
          An aspiring developer and designer passionate about creating
          beautiful, functional digital experiences and craft eye-catching
          visual designs. I'm currently learning and building projects to
          sharpen both my coding and design skills.
        </p>
